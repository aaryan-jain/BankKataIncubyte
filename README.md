...
| AZURE_DNS_LABEL | The dns name label for container group with public IP. | `BankKataIncubyte` |


### Verification
Call the rest api endpoint `[AZURE_DNS_LABEL].[AZURE_LOCATION].azurecontainer.io:[PORT]/bankKataIncubyte`:
```
curl http://BankKataIncubyte.westeurope.westeurope.azurecontainer.io:8080/bankKataIncubyte
```
